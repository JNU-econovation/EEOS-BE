CREATE TABLE `notification_log` (
                                   ...
                                   `notification_log_category` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
                                   ...
                                   `notification_log_notification_status` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
                                   `notification_log_error_code` varchar(50) COLLATE utf8mb4_unicode_ci NULL,
                                   `notification_log_scheduled_at` datetime NOT NULL,
                                   `notification_log_sent_at` datetime NULL,
                                   `notification_log_provider` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
